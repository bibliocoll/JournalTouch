  ...
  <body>
    ...
    <!-- Navigation -->	
		...
		<nav class="top-bar" data-topbar data-options="is_hover: false">
			<ul class="title-area">
				<!-- Title Area -->
				<li class="name">
					<h1>JournalTouch <em><strong>beta</strong></em> - a library service
					</h1>
				</li>
			...
			<section class="top-bar-section">
				<ul class="left hide-for-small">
					<li><a href="#" id="aboutLink" data-reveal-id="about" class="button radius"><i class="fi-info"></i> about</a></li>
				</ul>
				<!-- Right Nav Section -->
				<ul class="right">
					<li class="divider"></li>
					...
					<li class="has-dropdown"><a id="filter-view" href="#"><i class="fi-filter"></i>&nbsp;filter</a>
						<ul class="dropdown">
                            ...
                            ?>
							<li><a class="filter" id="filter-reset" href="#"><i class="fi-refresh"></i>&nbsp;show all</a></li>
						</ul>
					</li>
                    <?php } ?>
					<li><a id="switch-view" href="#"><i class="switcher fi-list"></i><span>&nbsp;list view</span></a></li>
					<li><a href="#" id="myArticles" data-reveal-id="cartPopover"><i class="fi-shopping-bag"></i>&nbsp;my basket (<span class="simpleCart_quantity"></span>)</a></li>
				</ul>
			</section>
		</nav>
		</div>
		...
		<a href="#" id="stickyBasket" class="button radius show-for-large-up" data-reveal-id="cartPopover"><i class="fi-shopping-bag"></i>&nbsp;Send articles </a>
    ...
    <!-- for small screens -->
		...
		<div id="about" class="reveal-modal" data-reveal>
			<div class="row">
				<div class="small-12 medium-12 large-12 columns left">
					<h2>About</h2>
					<p><em>JournalTouch</em> is the <strong>MPI Collective Goods library's</strong> alerting service for newly published journal issues.</p>
					<p>
						It's easy &dash; select a journal and add interesting articles to your shopping basket. If there is an abstract
			...
			<div class="row">
				<div class="small-8 medium-9 large-9 columns left">
					<p>
						If a journal is missing, please let us know and we will add it to the list.<br/><br/> <strong><em>JournalTouch</em> is actively being developed by the library team</strong>.
						<br/>	Tables of contents are provided by <strong>CrossRef</strong> and <strong>JournalTocs</strong>.
					</p>
				</div>
				
				<div class="small-4 medium-3 large-3 columns right">
					<ul class="inline-list right">
						<li><a class="button radius" href="checkout.php?action=contact"><i class="fi-comment"></i> Get in touch!</a></li>
					</ul>
				</div>
			</div>
		...
		<div id="cartPopover" class="reveal-modal" data-reveal>
			...
			<div id="shelfIsEmpty" style="display:none"><i class="fi-alert"></i> Your basket is empty.</div>
		...
		<div id="emptyConfirm" class="reveal-modal" data-reveal>
			...
			<a id="emptyCartButton" href="javascript:;" class="simpleCart_empty radius small alert button close-reveal-modal"><i class="fi-trash"></i> OK, empty my basket!</a>
...
-->			
		...
		<div id="view-accordion" class="row invisible">
			<div class="small-12 columns">
				...
				<h3>Browse all journals from A to Z (list view):</h3>
    ...
    <!-- Thumbnails -->
		<div id="view-grid">
			...
			<div class="row">
				<div class="small-12 columns">
          <h3>Browse all journals from A to Z (grid view):</h3>
				</div>
			</div>
      ...
      <div class="row">
            ...
            <p><em>JournalTouch</em> &copy; 2014 MPI Collective Goods Library, Bonn</p>
						<p>Tables of contents provided by <a href="http://www.crossref.org">CrossRef</a> and <a href="http://www.journaltocs.ac.uk/">JournalTocs</a></p>
		...
		<div id="screensaver" style="display:none">
			...
			<div class="row">
				<div class="small-8 medium-9 large-9 columns left">
					<p>
						If a journal is missing, please let us know and we will add it to the list.<br/><br/> <strong><em>JournalTouch</em> is actively being developed by the library team.</strong><br/>	
						Tables of contents are provided by <strong>CrossRef</strong> and <strong>JournalTocs</strong>.
					</p>
				</div>
			</div>

			<div class="row">
				<h1>Touch the screen to get started...</h1>
			</div>
